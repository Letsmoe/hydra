...
import { checkStructure, Config } from "./config/check.js";
...
function checkCreateDir(dir: string) {
 ...
 */
function controlCheck(dir: string, checkBack: ((str : string) => boolean) = () => false): number {
...
function executeConfig(config: Config) {
